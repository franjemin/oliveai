...
Refreshed from Backend PR #1 (`cursor/olive-v1-core-backend-a0fd`). When that
contract moves, copy `contracts/openapi.yaml` + `contracts/api.md` here again
and update `apps/mobile/src/api/`. Do not invent parallel route names.
